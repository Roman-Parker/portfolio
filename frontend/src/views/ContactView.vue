        ...
        <form>
          ...
          <div class="mb-4">
            ...
            <input
              ...
              class="w-full rounded py-2 px-3 text-gray-800
          ...
          <div class="flex items-center mb-4">
            <input
              type="checkbox"
              id="copy"
              class="rounded text-turquoise focus:ring-turquoise mr-2
                     cursor-pointer"
              checked
            />
            <label
          ...
          <button
            type="submit"
            class="w-full py-2 bg-turquoise hover:bg-turquoise-light
