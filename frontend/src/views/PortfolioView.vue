        ...
        <section class="container mx-auto px-4 py-8">
            ...
            <div class="flex flex-wrap justify-center gap-2 mb-8">
                <button
                    ...
                    class="px-4 py-2 rounded border border-accent transition-colors"
                    :class="
...
export default {
            ...
            projects: [
                {
                    ...
                    image: "https://via.placeholder.com/400x200.png?text=Vue+Docker+Project",
                    description: "A containerized Vue.js application showcasing containerization with Docker.",
                ...
                },
                {
                    ...
                    description: "Data processing pipeline built with Python, leveraging various libraries.",
                    technologies: ["Python"],
                ...
                },
                {
                    ...
                    image: "https://via.placeholder.com/400x200.png?text=Fullstack+JavaScript+App",
                    description: "A Node.js backend with a Vue frontend for real-time chat and data handling.",
                ...
                },
                {
                    ...
                    image: "https://via.placeholder.com/400x200.png?text=Container+Monitoring+Tool",
                    description: "A simple monitoring dashboard for Docker containers, built with Vue and Python.",
    ...
    computed: {
        ...
        filteredProjects() {
            ...
            return this.projects.filter((proj) => proj.technologies.some((tech) => this.selectedTechs.includes(tech)));
        },
    },
    methods: {
